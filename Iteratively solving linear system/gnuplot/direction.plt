...
set output 'directions_heatmap.png'

set title "Searching Directions Heatmap"
...
plot '../src/direction.txt' matrix rowheaders using 1:2:(log10(abs($3) + 1e-16)) with image